      ...
      <div className="p-5 border-b border-surface-700/50">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-sm font-bold text-surface-100 font-display truncate">Feedback System</h2>
            <p className="text-xs text-surface-500 capitalize">{role} Panel</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-surface-700/50">
        {user && (
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary-500 to-accent-cyan flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
