    ...
    <div className="min-h-screen flex flex-col bg-surface-950">
      ...
      <header className="gpn-header">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-5">
          {/* Logo */}
          <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center shadow-lg overflow-hidden border-2 border-white/20">
            <img src="/gpn_logo.png" alt="GPN Logo" className="w-full h-full object-contain p-1" />
          </div>
          <div>
